...
% \usepackage[utf8]{inputenc} % ctex handles encoding usually, but keeping it doesn't hurt. 
% Standard ctexart with UTF8 is default.
\usepackage[fontset=mac]{ctex} % Explicitly set fontset for Mac user since they are on Mac.
...
\bibitem[1]{li2018densefuse}
LI H, WU X J.
\newblock Densefuse: A fusion approach to infrared and visible images [J].
\newblock IEEE Transactions on Image Processing, 2018, 28(5): 2614-2623.

\bibitem[2]{ma2019fusiongan}
MA J Y, YU W, LIANG P W, et al.
\newblock Fusiongan: A generative adversarial network for infrared and visible image fusion [J].
\newblock Information Fusion, 2019, 48: 11-26.

\bibitem[3]{ma2022swinfusion}
MA J Y, TANG L F, FAN F, et al.
\newblock Swinfusion: Cross-domain long-range learning for general image fusion via swin transformer [J].
\newblock IEEE/CAA Journal of Automatica Sinica, 2022, 9(7): 1200-1217.

\bibitem[4]{tang2022seafusion}
TANG L F, YUAN J T, ZHANG H, et al.
\newblock Image fusion in the loop of high-level vision tasks: A semantic-aware real-time infrared and visible image fusion network [J].
\newblock Information Fusion, 2022, 82: 28-42.

\bibitem[5]{tang2022piafusion}
TANG L F, YUAN J T, MA J Y.
\newblock Piafusion: A progressive infrared and visible image fusion network based on illumination aware [J].
\newblock Information Fusion, 2022, 83: 79-92.

\bibitem[6]{liu2022target}
LIU J Y, FAN X, HUANG J J, et al.
\newblock Target-aware dual adversarial learning and a multi-scenario multi-modality benchmark to fuse infrared and visible for object detection [C]//Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).
\newblock 2022: 5802-5811.

\bibitem[7]{tang2022superfusion}
TANG L F, DENG Y X, MA Y, et al.
\newblock Superfusion: A versatile image registration and fusion network with semantic awareness [J].
\newblock IEEE/CAA Journal of Automatica Sinica, 2022, 9(12): 2121-2137.

\bibitem[8]{hou2021coordinate}
HOU Q B, ZHOU D Q, FENG J S.
\newblock Coordinate Attention for Efficient Mobile Network Design [C]//Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).
\newblock 2021: 13713-13722.

\bibitem[9]{tang2022msrs}
TANG L F, LI C, MA J Y.
\newblock MSRS: Multi-spectral road scenarios for practical infrared and visible image fusion [C]//Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).
\newblock 2022.
